...
class ConverterRegistry:
    ...
    def merge_from(self, other: "ConverterRegistry") -> None:
        ...
        Converters from the other registry are added to this registry.
        If a converter for a type already exists in this registry, it is
        preserved (current registry values take precedence).

        This implements a "child wins" merge strategy where existing converters
        in this registry are not overwritten by converters from the other registry.
